...
// 	const { verified,istrationInfo) return { verified: false, message: "Verification failed" }
...
// export async function getAuthenticationOptions(username: string the logged-in user
// 	const user = getUserFromions: undefined, message: "User not found" }
